                ...
                <div className="about-wrapper">
                    <AnimatePresence mode="wait">
                    {
                        ...
                        (
                            ...
                            >
                                <p className="one">
                                    <span>Attuned</span> is a non-profit association based in Brussels that organises <span>benefit parties</span> to raise funds for social causes. Since its inception in 2023, Attuned has managed to raise over <span>6000€</span> over the course of 6 parties for various local organisations working within the human rights and agroecological spheres.<br/>
                                    It places at the center of its organisation the principles of partnership and of circular economy, taking to heart the blooming of meaningful and lasting collaborations with local partners.
                                </p>
